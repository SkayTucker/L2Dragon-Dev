...
public class QuestLink implements IBypassHandler
{
	...
	{		
        ...
        sb.append("<html><body><title>Sele̤̣o de Misṣo</title>");
        sb.append("<center>");
        sb.append("<font color=\"LEVEL\">Em Progresso</font> = Misṣo em andamento.<br1>");
        sb.append("<font color=\"00FF00\">Realizado</font> = Misṣo finalizada.<br>(ainda Pode haver intera̤̣o.)<br><br>");
        sb.append("<font color=\"C0C0CA\"> se vazio </font>= Pode ou Ṇo haver Misṣo.<br>");
        sb.append("Misṣo: <br>");
        for (Quest q : quests) 
        {
